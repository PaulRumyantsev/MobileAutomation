...
public class WelcomePageObject extends MainPageObject
{
    ...
    CLICK_NEXT_BUTTON = "id:Next",
    CLICK_GET_STARTED_BUTTON = "id:Get started";
    ...
    {
        this.waitForElementAndClick(CLICK_NEXT_BUTTON,"Cannot find 'Next' button",10);
    }

    public void clickGetStartedButton()
    {
        this.waitForElementAndClick(CLICK_GET_STARTED_BUTTON,"Cannot find 'Get started' button",10);
    }
}
